...
plt.gray()
plt.show()
plt.title("Unblurring using deconvolution")
plt.imshow(a)
plt.gray()
plt.show()
...
print("and another one is that inverse filtering is said to be numerically unstable (that's why limit is set).")
print("Estimating the PSF is very crucial, and very slight innacuracy could be greatly amplified in a phenomenon called 'ringing', that is why it is unstable.")
print("")
